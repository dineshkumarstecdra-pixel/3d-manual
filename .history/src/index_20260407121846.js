...
function updateFloatingLabel() {
  ...
  const labelHeight = floatingLabel.offsetHeight || 150;

  // மவுஸ் கர்சருக்கு மிக அருகில் லேபிள் வராமல் இருக்க ஒரு சிறிய இடைவெளி (Offset)
  let x = currentMouseX + 15; 
  let y = currentMouseY + 15;

  // 1. மவுஸ் திரையின் வலது ஓரத்திற்குச் சென்றால், லேபிளை மவுசுக்கு இடதுபுறம் மாற்றுதல்
  if (x + labelWidth > window.innerWidth) {
    x = currentMouseX - labelWidth - 15;
  }

  // 2. மவுஸ் திரையின் கீழ் ஓரத்திற்குச் சென்றால், லேபிளை மவுசுக்கு மேற்புறம் மாற்றுதல்
  if (y + labelHeight > window.innerHeight) {
    y = currentMouseY - labelHeight - 15;
  }

  // பழைய சென்டர் அலைன்மெண்ட்டை நீக்குகிறோம்
  floatingLabel.style.transform = "none"; 
  
  // புதிய இடத்தைச் செட் செய்கிறோம்
