...
/* ================= label (SMART 2D BOUNDS FIX) ================= */
function updateFloatingLabel() {
  if (!floatingLabel) return;
  if (!selectedPart || floatingLabel.style.display !== "block") return;

  // 1. தேர்ந்தெடுக்கப்பட்ட பாகத்தின் 3D எல்லையைக் கண்டுபிடிக்கிறோம்
  ...
  // 4 திசைகளுக்கான எல்லைகளைச் சேமிக்க
  ...
  // 2. 8 மூலைகளையும் 2D ஸ்கிரீனுக்கு மாற்றி, மாடலின் அகலம், உயரத்தைக் கண்டுபிடிக்கிறோம்
  corners.forEach(corner => {
    const projected = corner.clone().project(camera);
    if (projected.z > 1) return; // கேமராவுக்குப் பின்னால் இருந்தால் தவிர்க்கிறோம்
  ...
  // 3. Default Position: மாடலின் வலது-மேற்புற விளிம்பில் வைக்கிறோம்
  let finalX = maxScreenX + 20;
  let finalY = minScreenY - 20;

  // --- 🔥 SMART COLLISION FIX 🔥 ---
  
  // A. திரையின் வலது ஓரத்தில் இடம் இல்லை என்றால், மாடலுக்குள் தள்ளாமல், 
  // முழுமையாக மாடலின் இடதுபுறத்திற்கு (Left Side) மாற்றிவிடுகிறோம்!
  if (finalX + labelWidth > window.innerWidth) {
    finalX = minScreenX - labelWidth - 20; 
  }

  // B. திரையின் மேல் ஓரத்தில் இடம் இல்லை என்றால், மாடலின் கீழ்ப்புறத்திற்கு (Bottom Edge) மாற்றுகிறோம்
  if (finalY < 0) {
    finalY = maxScreenY + 20;
  }

  // C. ஒருவேளை மாடலே திரையை விடப் பெரிதாக இருந்தால் (Extreme Zoom),
  // லேபிள் திரையை விட்டு வெளியே போகாமல் இருக்க ஓரத்திலேயே ஒட்டி வைக்கிறோம்
  ...
  // 4. லேபிளைச் சரியான இடத்தில் பொருத்துகிறோம்
