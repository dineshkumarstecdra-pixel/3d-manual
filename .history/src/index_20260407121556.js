...
function updateFloatingLabel() {
  ...
  // மாடலுக்கு மிக அருகில் வராமல் சற்று மேலே தள்ளி வைக்கிறோம் (0.08 லிருந்து 0.05)
  worldPos.y += distance * 0.05 
  ...
  // திரையின் எல்லைகளைத் தாண்டாமல் இருக்க செக்கிங்
  if (x + labelWidth + 20 > window.innerWidth) x = window.innerWidth - labelWidth - 20
  if (x < SIDEBAR_WIDTH) x = SIDEBAR_WIDTH + 20

  // 🔥 THE FIX: '-50%' என்ற மையப் பகுதியை நீக்கிவிட்டு, '20px' வலதுபுறம் தள்ளுகிறோம்.
  if (y - labelHeight < 0) {
    floatingLabel.style.transform = "translate(20px, 20px)" // கீழே வலதுபுறம்
  } else {
    floatingLabel.style.transform = "translate(20px, -100%)" // மேலே வலதுபுறம்
  }
